...
//	}
	...
	int[] calcErrorPositionVariable(int[] s) {
		...
		// calc ��1
		e[0] = s[0];
		//System.out.println("��1 = " + String.valueOf(e[0]));
		...
		//System.out.println("��2 = " + String.valueOf(e[1]));
		...
		t = (s[0] + e[1]) % 15;
		e[2] = addGF(t1, t);
		//System.out.println("��3 = " + String.valueOf(e[2]));
	...
	boolean[] correctErrorBit(boolean[] y, int[] errorPos) {
		//errorPos[0]�ɃG���[�̐��AerrorPos[1],[2],[3]�Ɏ��ۂ̈ʒu�������Ă���
