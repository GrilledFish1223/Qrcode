...
//		return new QRCodeContent(decodedString);
	...
	int[][] findAreaMiddle(int[][] image) {
		...
		//4x4�̃G���A���Ƃ̖��邳�̒��Ԓl((min + max) / 2)���o��
	...
	boolean[] getFormatInformation(QRCodeSymbol qRCodeMatrix) {
		...
		for (int i = 0; i <= 14; i++) {
			...
			if (modules[i] == xorBit) //�r�b�g�V�t�g������̈ꌅ�ڂ�����
				modules[i] = false;
			else
				modules[i] = true;
		}
				...
				if (direction == READ_UP) {
					if ((x + isNearFinish) % 2 == 0) //���̂����E���Ȃ�
						...
						if (y > 0) { //��ɐi�߂�
							...
							if (x == 6){
								x--;
								isNearFinish=1; // �c�̃^�C�~���O�p�^�[����ʉ߂��邱�Ƃɂ���Ĕ����ς���
							}
							direction = READ_DOWN;
						}
					}			
...
//			System.out.println("numWords="+String.valueOf(blocks.length));
		...
		else  { //RS�u���b�N��2�ȏ�̂��߁A�f�[�^�u���b�N���ёւ�����
			int numLongerRSBlocks = dataCapacity % numRSBlocks;
			
			if (numLongerRSBlocks == 0) { //RS�u���b�N��1���
